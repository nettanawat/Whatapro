;(function($) {
  $.fn.quicksearch = function(options) {
    ...
    function make_form() {
      return '<div ' + 'id="' + options.formId + '" ' + 'class="quicksearch col-md-4">'
    ...
    function make_form_input() {
      ...
      return '<input type="text" class="form-control" placeholder="Search" value="' + val + '" rel="' + options.randomElement + '" class="' + options.inputClass + '" id="' + options.randomElement + '" /> ';
    }
