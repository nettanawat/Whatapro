...
echo '<div style="margin-top: 20px; padding-bottom: 50px" class="container-fluid text-center">
...
<div style="padding-top: 30px;" class="container-fluid text-center">
...
<nav class="navbar navbar-fixed-bottom">
    <div class="container-fluid">
        <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo Config::PATH.'/user';?>#top"><strong style="text-decoration: none; color: orangered">Back to top</strong></a></li>
        </ul>
    </div>
</nav>
